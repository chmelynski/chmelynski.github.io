...
// var en = { leftmin : 2 , rightmin : 2 , patterns : { 3 : <string> , 4 : <string> , ... } }
// en is fed to the constructor Hypher(language)
...
// ["con", "ti", "nen", "t,"] - seems like the comma is screwing things up - we wouldn't want to see continen-t
// ["de", "trac", "t."]

// perhaps we should strip trailing punctuation, then hypenate, and then re-add the punctuation?
// (note we should only strip trailing punctuation - i wonder how apostrophes interact with Hypher though)

// ["bat", "tle-", "field"] - what happens when there is an existing hyphen?
...
class Hypher {
	...
	hyphenateText(str: string, minLength: number = 4): string {
